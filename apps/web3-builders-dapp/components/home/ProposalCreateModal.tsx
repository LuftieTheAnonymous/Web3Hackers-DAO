...
{address && currentUser && !isLoading ?    <div className="max-w-2xl my-6 border-(--hacker-green-4) border drop-shadow-purple-700 hover:-translate-y-1 transition-all duration-500 drop-shadow-sm mx-auto rounded-lg flex flex-col gap-2  w-full h-80 bg-zinc-800">
      ...
      </div>
{
  ...
  <ProposalModal>
<div
className='text-white text-sm outline-none border-none bg-neutral-900 p-2 rounded-lg hover:text-neutral-900 hover:bg-(--hacker-green-4) max-w-32 w-full transition-all cursor-pointer'>
  Propose
</div>
  </ProposalModal>
}
