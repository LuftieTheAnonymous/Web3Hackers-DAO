...
// Constant values
    uint256 public constant MAX_SUPPLY = 21e24;
...
function burn(address account, uint256 amount) external onlyManageRole onlyWhitelisted(account) {
_burn(account, amount);
}

function burnOwnTokens (uint256 amount) external {
